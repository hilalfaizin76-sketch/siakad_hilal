...
if (!isset($_SESSION['isLogin']) || $_SESSION['isLogin'] != true) {
    header("Location: ../index.php"); // paksa ke login
    exit();
}
?>
...
<html lang="en">
  ...
  <head>
    ...
    <meta name="theme-color" content="#ff00ddff" media="(prefers-color-scheme: light)" />
            ...
            <li class="nav-item dropdown user-menu">
              <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                <img
                  ...
                  alt="User Image"
                />
                <span class="d-none d-md-inline">Hilal faizin </span>
              </a>
              <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                ...
                <li class="user-footer">
                 ...
                 <a href="logout.php" class="btn btn-default btn-flat float-end text-danger fw-bold">Logout</a>
...
<main class="app-main">
    <div class="app-content p-3">
        <!-- Konten dari route.php akan tampil di sini -->
...
<!--end::App Main-->
      ...
      <footer class="app-footer">
        ...
        <strong>
          ...
          <a href="https://www.instagram.com/n_himam08?igsh=NjVoeWN3cXA0cnZp" class="text-decoration-none">Hilal</a>.
        </strong>
        All rights reserved.
        <!--end::Copyright-->
      </footer>
